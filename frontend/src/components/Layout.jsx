...
const NAV = [
  ...
  { path: '/lab-calls', label: 'Lab Calls', icon: '◎' },
  { path: '/masterminds', label: 'Masterminds', icon: '◆' },
...
const styles = {
  sidebar: {
    background: 'linear-gradient(180deg, #003DA6 0%, #002d7a 100%)',
    display: 'flex',
    ...
    overflow: 'hidden',
    boxShadow: '4px 0 20px rgba(0,61,166,0.25)',
  },
  logo: {
    display: 'flex',
    alignItems: 'center',
  ...
  logoSub: { fontSize: '11px', color: 'rgba(255,255,255,0.5)', letterSpacing: '0.04em', marginTop: '2px' },
  nav: { flex: 1, padding: '16px 0', display: 'flex', flexDirection: 'column', gap: '2px' },
  navItem: {
  ...
  navLabel: { fontFamily: 'var(--font-display)', fontWeight: '600', fontSize: '13px' },
  sidebarBottom: {
    padding: '16px',
  ...
  avatar: {
    ...
    fontSize: '13px', fontWeight: '700', color: 'var(--white)',
  },
  userDetails: { overflow: 'hidden' },
  userName: { fontSize: '13px', fontWeight: '600', color: 'var(--white)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  userRole: { fontSize: '11px', color: 'var(--gold)', textTransform: 'capitalize', fontWeight: '500' },
  logoutBtn: {
